...
# %bb.5:                                # %pred.store.continue
	...
	testb	$1, %dl
	jne	.LBB0_6
.LBB0_7:                                # %pred.store.continue77
                                        #   in Loop: Header=BB0_3 Depth=2
	pextrw	$4, %xmm1, %edx
	testb	$1, %dl
	jne	.LBB0_8
.LBB0_9:                                # %pred.store.continue79
                                        #   in Loop: Header=BB0_3 Depth=2
	pextrw	$6, %xmm1, %edx
	testb	$1, %dl
	je	.LBB0_11
...
.L__PRETTY_FUNCTION__._ZL7gettimev:
	...
	.ident	"clang version 12.0.0 (git@github.com:llvm/llvm-project.git d28af7c654d8db0b68c175db5ce212d74fb5e9bc)"
